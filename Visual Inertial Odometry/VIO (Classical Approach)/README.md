...
## Run  
`python Code/vio.py --view --path path/to/your/EuRoC_MAV_dataset/MH_01_easy`  
or    
`python Code/vio.py --path path/to/your/EuRoC_MAV_dataset/MH_01_easy` (no visualization)  
